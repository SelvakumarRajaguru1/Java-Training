...
public class AsyncEg {
	...
	private static void thenRunMethod() {
		CompletableFuture<String> future = CompletableFuture.supplyAsync(() -> "Selva");
	...
	private static void chainOfCallbackMethods() {
		CompletableFuture<Void> future = CompletableFuture.supplyAsync(() -> {
			...
			return "Selva";
		}).thenApply(value -> "Hello from " + value + " !!!").thenApply(msg -> msg + " Selva welcomes you all")
				.thenAccept(System.out::println);

	}

	private static void thenComposeMethod() {
		CompletableFuture<String> compFuture = CompletableFuture.supplyAsync(() -> "Selva")
	...
	private static void allOfMethod() {
		...
		CompletableFuture<String> cFuture3 = CompletableFuture.supplyAsync(() -> "Selva");
