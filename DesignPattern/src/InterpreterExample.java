...
interface Expression {
 boolean interpret(Employee2 employee);
}
...
class OrExpression implements Expression {
 ...
 public boolean interpret(Employee2 employee) {
...
public class InterpreterExample {
 public static void main(String[] args) {
     ...
     employees.add(new Employee2("John", 1));
     employees.add(new Employee2("Jane", 2));
     employees.add(new Employee2("Bob", 3));
